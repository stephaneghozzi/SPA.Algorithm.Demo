...
- if an approach is excluded based on disease or feature / objective, i.e. if *Disease Score* = 0 or *Objective score* = 0, then the approach should be excluded, i.e. *CDO Score* = 0;
...
- *CDO Score* as the [weighted geometric mean](https://en.wikipedia.org/wiki/Weighted_geometric_mean) of *Country Score*, *Disease Score*, and *Objective score*:
  - *CDO Score* = (*Country Score* ^ *wc* * *Disease Score* ^ *wd* * *Objective score* ^ *wo*) ^ (1/(*wc* + *wd* + *wo*)),
...
- when, as by default, all weights are equal, then *CDO Score* becomes the [geometric mean](https://en.wikipedia.org/wiki/Geometric_mean) of *Country Score*, *Disease Score*, and *Objective score*:
  - *CDO Score* = (*Country Score* * *Disease Score* * *Objective score*) ^ (1/3)
